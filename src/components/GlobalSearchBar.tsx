...
const SEARCH_DATABASE: SearchItem[] = [
  ...
  {
    id: "tool-translate",
    title: "Lồng Tiếng Video AI (Dịch & Auto Dub)",
    category: "tool",
    categoryLabel: "Video & Editing",
    description: "Nhận diện giọng nói, dịch tự động bằng Gemini/ATP Voice, lồng tiếng đa ngôn ngữ",
    icon: Languages,
    tabTarget: "translate",
    badge: "Auto Dub",
  ...
  {
    id: "tool-account-manager",
    title: "Quản Lý Tài Khoản (Multi-Profile & Cookie)",
    category: "tool",
    categoryLabel: "Quản Trị & Profile",
    description: "Quản lý profile trình duyệt, lấy cookie Facebook, TikTok, YouTube, Instagram, X, Zalo Video, check live hàng loạt",
    icon: UserCheck,
    tabTarget: "account-manager",
    badge: "New Pro",
    badgeColor: "bg-rose-500/20 text-rose-300 border-rose-500/30",
    keywords: ["quản lý tài khoản", "tài khoản", "cookie", "profile", "facebook", "tiktok", "youtube", "instagram", "zalo video", "x", "check live", "trình duyệt", "chrome", "antidetect"]
  },
  {
    id: "tool-proxy-manager",
    title: "Quản Lý Proxy (Proxy Pool & Auto Assign)",
    category: "tool",
    categoryLabel: "Quản Trị & Proxy",
    description: "Quản lý danh sách Proxy, check live latency, tự động phân phối và gán proxy cho tài khoản mạng xã hội",
    icon: Globe,
    tabTarget: "proxy-manager",
    badge: "Proxy Pool",
    badgeColor: "bg-rose-500/20 text-rose-300 border-rose-500/30",
    keywords: ["quản lý proxy", "proxy", "http proxy", "socks5", "check live proxy", "gán proxy", "ip", "xoay ip", "tài khoản"]
  },
  {
    id: "tool-post-schedule",
    title: "Lịch Trình Đăng Bài (Post Queue & Schedule)",
    category: "tool",
    categoryLabel: "Quản Trị & Lịch Trình",
    description: "Quản lý hàng đợi bài đăng, lọc theo ngày/ghi chú, sao chép lịch trình, kiểm soát trạng thái hoàn thành",
    icon: Clock,
    tabTarget: "post-schedule",
    badge: "Schedule",
    badgeColor: "bg-rose-500/20 text-rose-300 border-rose-500/30",
    keywords: ["lịch trình đăng bài", "lịch đăng", "hẹn giờ", "đăng bài", "sao chép lịch trình", "quản lý lịch", "status", "queue"]
  },
  {
    id: "tool-bulk-scheduler",
    title: "Lên Lịch Hàng Loạt (Bulk Scheduler & Cycle Planner)",
    category: "tool",
    categoryLabel: "Quản Trị & Lên Lịch",
    description: "Lên lịch đăng bài hàng loạt, phân bổ theo chu kỳ, gán video cho danh sách tài khoản tự động",
    icon: Calendar,
    tabTarget: "bulk-scheduler",
    badge: "Bulk Plan",
    badgeColor: "bg-rose-500/20 text-rose-300 border-rose-500/30",
    keywords: ["lên lịch hàng loạt", "lên lịch", "phân bổ chu kỳ", "chọn videos", "thêm lịch trình", "hàng loạt", "auto post", "bulk schedule"]
  },
  {
    id: "tool-fanpage-reels",
    title: "Đăng Reels Fanpage (Facebook Reels Auto Poster)",
    category: "tool",
    categoryLabel: "Đăng Bài & Reels",
    description: "Tự động đăng Reels Fanpage Facebook, phân phối thư mục video, rewrite AI caption, hẹn giờ đăng và chạy bằng Chrome automation",
    icon: Flag,
    tabTarget: "fanpage-reels",
    badge: "Reels Auto",
    badgeColor: "bg-rose-500/20 text-rose-300 border-rose-500/30",
    keywords: ["đăng reels fanpage", "reels", "fanpage", "facebook reels", "chọn video", "chọn nhóm video", "thư mục video", "lịch sử upload", "chia đều video", "chrome", "auto post reels"]
  },
  {
    id: "tool-tiktok-post",
    title: "Đăng Tiktok (TikTok Auto Poster & Scheduler)",
    category: "tool",
    categoryLabel: "Đăng Bài & Reels",
    description: "Tự động đăng video TikTok hàng loạt, bỏ qua kiểm tra bản quyền, chọn nhóm video, AI rewrite caption và quản lý trình duyệt Chrome automation",
    icon: Music2,
    tabTarget: "tiktok-post",
    badge: "TikTok Auto",
    badgeColor: "bg-pink-500/20 text-pink-300 border-pink-500/30",
    keywords: ["đăng tiktok", "tiktok", "bản quyền", "bỏ qua kiểm tra bản quyền", "chọn video", "chọn nhóm video", "thư mục video", "lịch sử upload", "chrome", "auto post tiktok"]
  },
  {
    id: "tool-ai-manager",
    title: "Quản Lý AI (API Key Pool)",
    category: "tool",
    categoryLabel: "Quản Trị & API",
    description: "Quản lý và luân phiên AI API Key (Gemini, OpenAI, Claude) chống chạm ngưỡng Rate-Limit",
    icon: KeyRound,
    tabTarget: "ai-manager",
    badge: "Key Pool",
    badgeColor: "bg-rose-500/20 text-rose-300 border-rose-500/30",
    keywords: ["quản lý ai", "ai key", "gemini", "openai", "claude", "api key", "xoay vòng", "rate limit", "token"]
  },
  {
    id: "tool-phone-farm",
