...
/// <summary>
/// Đại diện cho một phân đoạn highlight video được trích xuất.
/// </summary>
...
/// <summary>
/// Cấu hình tham số cho thuật toán Fusion Scoring.
/// </summary>
public sealed record HighlightOptions
{
    public int SampleRate { get; init; } = 16000;
    public int WindowSizeN { get; init; } = 2048; // N = 2048 mẫu (128ms tại 16kHz)
    public int HopSizeH { get; init; } = 512;     // H = 512 mẫu (32ms hop)
    public double SceneThreshold { get; init; } = 0.38; // Ngưỡng chuyển cảnh FFmpeg
    public double MinSegmentDurationSec { get; init; } = 15.0; // Tối thiểu 15 giây
    public double MaxSegmentDurationSec { get; init; } = 45.0; // Tối đa 45 giây
    public double TargetSegmentDurationSec { get; init; } = 30.0; // Chuẩn 30 giây
