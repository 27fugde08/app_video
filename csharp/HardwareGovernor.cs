...
/// <summary>
/// Event arguments fired when GPU VRAM exceeds safe operating threshold (85%).
/// </summary>
...
/// <summary>
/// Status of an acquired encoder lease.
/// </summary>
...
/// <summary>
/// RAII lease token representing an active encoding slot.
/// Disposing this token deterministically releases the SemaphoreSlim slot.
/// </summary>
public sealed class EncoderLease : IAsyncDisposable, IDisposable
{
    ...
    /// <summary>
    /// FFmpeg video encoder flag configured based on acquired hardware slot.
    /// </summary>
    public string FfmpegEncoderFlag => IsCpuFallback ? "libx264" : "h264_nvenc";

    /// <summary>
    /// Recommended FFmpeg preset for current operational mode.
    /// </summary>
...
/// <summary>
/// Snapshot of GPU & System memory metrics queried via DXGI 1.4 / Windows API.
/// </summary>
public readonly record struct GpuMemoryMetrics(
